...
export class NzCalendarComponent implements OnInit, OnChanges {
  ...
  __clickDay(day: DayInterface): void {
    // if (!this.nzShowTime) {
    //   this._closeCalendar();
    //   this.nzValue = day.date.toDate();
    //   // this.onChange(this._value);
    //   this.nzValueChange.emit(this._value)
    // } else {
  ...
  __clickMonth(month: MonthInterface): void {
